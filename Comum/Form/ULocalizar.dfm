object frmLocalizar: TfrmLocalizar
  ...
  object Label1: TLabel
    ...
    Height = 13
    Alignment = taCenter
    Caption = 'Marque as colunas que ser'#227'o exibidas na consulta:'
  end
  object Label2: TLabel
    ...
    Height = 13
    Alignment = taCenter
    Caption = 'Filtros considerados para a pesquisa:'
  end
  object Label3: TLabel
    ...
    Width = 141
    Height = 13
    Caption = 'Informe os valores para o filtro'
  end
  object lvw: TListView
    Left = 8
    Top = 27
    Width = 249
    Height = 429
    ...
    TabOrder = 0
    ViewStyle = vsReport
    OnSelectItem = lvwSelectItem
  end
  object lvwP: TListView
    Left = 260
    Top = 300
    Width = 421
    Height = 157
    ...
    ViewStyle = vsReport
    OnClick = lvwPClick
    OnKeyDown = lvwPKeyDown
    OnSelectItem = lvwPSelectItem
  end
