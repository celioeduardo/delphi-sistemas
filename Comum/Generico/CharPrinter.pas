...
Para quem não entendeu como utilizar a biblioteca acima, segue abaixo um código de exemplo para a utilização desta biblioteca. Anexe este código ao evento OnClick de um botão qualquer em seu formulário e teste.

Não se esqueça de acrescentar CharPrinter na cláusula Uses de seu formulário
